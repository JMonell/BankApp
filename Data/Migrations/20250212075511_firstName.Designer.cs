...
namespace BankApp.Migrations
{
    ...
    [Migration("20250212075511_firstName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Models.Account", b =>
                {
                    b.HasOne("BankApp.Data.ApplicationUser", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BankApp.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
